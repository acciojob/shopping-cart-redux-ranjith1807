...
export default function Cart() {
  ...
  const discountAmount = (subtotal * (coupon.discountPercent || 0)) / 100;
          ...
          <>
              ...
              <div className="card shadow-sm border-0 rounded-4 bg-white p-4">
                ...
                <div className="d-flex flex-column gap-4">
                  {cart.map((item) => (
                    <div
                      key={item.id}
                      className="d-flex align-items-center justify-content-between flex-wrap pb-4 border-bottom gap-3"
                    >
                      <div className="d-flex align-items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-muted mb-2 text-uppercase" style={{ fontSize: '11px' }}>
                            {item.category}
                          </p>

                          <div className="d-flex gap-2 mb-2">
                            <span className="text-muted" style={{ fontSize: '12px' }}>
                              COLOR: <strong className="text-dark">{item.color || 'BLACK'}</strong>
                            </span>
                            <span className="text-muted" style={{ fontSize: '12px' }}>
                              SIZE: <strong className="text-dark">{item.size || 'M'}</strong>
                            </span>
                          </div>
                      ...
                      <div className="d-flex align-items-center gap-4 ms-auto">
                        <div className="d-flex align-items-center border rounded-2 px-1 bg-light">
                          ...
                          <span
                            className="fw-bold px-2 text-dark"
            ...
            <div className="col-12 col-lg-4">
              <div className="card shadow-sm border-0 rounded-4 bg-white p-4">
                ...
                {coupon.error && (
                  <p className="text-danger small mb-0 mt-1" style={{ fontSize: '12px' }}>
                    {coupon.error}
                  </p>
                )}

                {coupon.applied && (
                  <p className="text-success small mb-0 mt-1 fw-bold" style={{ fontSize: '12px' }}>
